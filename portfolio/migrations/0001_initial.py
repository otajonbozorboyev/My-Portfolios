    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.CharField(help_text='Enter the year', max_length=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.CharField(help_text='Enter your job. E.g.: Software Engineer', max_length=100)),
                ('social_media', models.JSONField(blank=True, help_text='Add your social media links', null=True)),
                ('icon', models.ImageField(blank=True, null=True, upload_to='about_me/icon')),
                ('image1', models.ImageField(blank=True, null=True, upload_to='about_me/image')),
                ('image2', models.ImageField(blank=True, null=True, upload_to='about_me/image')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('skills', models.ManyToManyField(blank=True, help_text='Add your skills', to='portfolio.skill')),
            ],
        ),
        migrations.CreateModel(
            name='Education',
